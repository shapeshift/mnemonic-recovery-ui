...
function App() {
  return (
    <ChakraProvider theme={theme}>
      <Flex flexDir='column' p={{ base: 0, md: 8}} className="App" bgImage={Bg} backgroundSize='cover' minHeight='100vh'>
        <Container mb={6} my='auto' px={0}>
          <Card borderRadius={{ base: 0, sm: 'xl'}} backdropFilter='blur(50px)' overflow='hidden' borderWidth={1}>
        ...
        <Link fontSize='xl' mt={{ base: 4, md: 'auto'}} mx='auto' isExternal href='https://github.com/shapeshift/mnemonic-recovery-ui'>
          <FaGithub />
        </Link>
      </Flex>
    </ChakraProvider>
